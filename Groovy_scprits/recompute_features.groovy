...
removeMeasurements(qupath.lib.objects.PathDetectionObject,
"Smoothed: 50 µm: Distance to annotation with Other µm", 
"Distance to annotation with Other µm",
"Smoothed: 50 µm: Cluster mean: Distance to annotation with Other µm",
"Smoothed: 25 µm: Cluster mean: Distance to annotation with Other µm",
"Smoothed: 25 µm: Distance to annotation with Other µm", 
"Cluster mean: Distance to annotation with Other µm",
