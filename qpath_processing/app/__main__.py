...
@click.command()
@click.option('--cell-position-file_path', help='Cells position file path.', required=True)
@click.option('--s1-geojson-path', help='s1 geojson file path.', required=True)
@click.option('--pixel-file-path', help='pixel size file path.', required=True)
...
@click.option('--output-file-path', help='output file path', required=True)
@click.option('--visualisation-flag', is_flag=True)
def process(cell_position_file_path, s1_geojson_path, pixel_file_path,
